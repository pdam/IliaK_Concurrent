...
if __name__ == '__main__':
     ...
     #time.sleep(2)
     p3 = subprocess.Popen('python testRunner.py cfg_IE_ANY_5560.ini')
     ##p5 WORKS!
     p5 = subprocess.Popen('python testRunner.py cfg_Android_Android_5554.ini')
     ##p6 WORKS
     #p6 = subprocess.Popen('python testRunner.py cfg_Android_Android_5556.ini')
